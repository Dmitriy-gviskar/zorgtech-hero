...
const PROJECTS = [
  ...
  { meta: 'Промышленность', title: 'Автоматизация фабрики «Донской табак»', slug: 'автоматизация-фабрики-донской-табак' , oldSlug: 'terminal-dlya-avtomatizatsii-proizvodstva-fabriki-donskoy-tabak' },
  ...
  // Page 3
  { meta: 'Культура', title: 'Музейный Гид для Дома русского зарубежья', slug: 'музейный-гид-для-дома-русского-зарубежья' , oldSlug: 'ulichnyy-sensornyy-terminal-dlya-dom-russkogo-zarubezhya-imeni-aleksandra-solzhenitsyna' },

  { meta: 'Транспорт', title: 'Навигация для аэропортов Краснодара и Анапы', slug: 'навигация-для-аэропортов-краснодара-и-анапы' , oldSlug: 'navigatsiya-dlya-aeroportov-krasnodara-i-anapy' },

  { meta: 'Ритейл', title: 'Навигация для МТК «5 Планет»', slug: 'навигация-для-мтк-5-планет' , oldSlug: 'interaktivnaya-navigatsiya-dlya-mtk-5-planet-moskva' },

  { meta: 'Образование', title: 'Академия цифровых технологий СПб', slug: 'академия-цифровых-технологий-спб' , oldSlug: 'akademiya-tsifrovykh-tekhnologiy-g-sankt-peterburg' },
  ...
  { meta: 'Ритейл', title: 'Терминал для продажи билетов в кинотеатре', slug: 'терминал-для-продажи-билетов-в-кинотеатре' , oldSlug: 'terminal-dlya-prodazhi-biletov-v-kinoteatre' },

  { meta: 'Медицина', title: 'Киоски для ММК Сколково', slug: 'киоски-для-ммк-сколково' , oldSlug: 'kioski-dlya-mezhdunarodnogo-meditsinskogo-klastera-skolkovo' },

  { meta: 'Недвижимость', title: 'ЖК «Новые Ватутинки»', slug: 'жк-новые-ватутинки' , oldSlug: 'zhk-novye-vatutinki-novye-tekhnologii' },

  { meta: 'Культура', title: 'Музей «Собрание» и интерактивные столы', slug: 'музей-собрание-и-интерактивные-столы' , oldSlug: 'muzey-sobranie-i-interaktivnye-stoly-zorgtech' },

  { meta: 'Авто', title: 'Zorgtech и Mercedes', slug: 'zorgtech-и-mercedes' , oldSlug: 'zorgtech-i-mercedes-dlya-tekh-kto-vybiraet-luchshee' },

  // Page 4
  { meta: 'Транспорт', title: 'Аэропорт Шереметьево', slug: 'аэропорт-шереметьево' , oldSlug: 'sensornye-terminaly-dlya-aeroporta-sheremetevo' },

  { meta: 'Транспорт', title: 'Аэропорт Домодедово', slug: 'аэропорт-домодедово' , oldSlug: 'sensornye-terminaly-dlya-aeroporta-domodedovo' },

  { meta: 'Ритейл', title: 'Сенсорные киоски для Amway', slug: 'сенсорные-киоски-для-amway' , oldSlug: 'krasivye-sensornye-kiosk-dlya-amway' },

  { meta: 'Банки', title: 'Молодёжный корнер Сбербанка', slug: 'молодёжный-корнер-сбербанка' , oldSlug: 'razrabotka-molodezhnogo-kornera-dlya-sberbanka' },
  ...
  { meta: 'Культура', title: 'Интерактивные проекты с галереей Глазунова', slug: 'интерактивные-проекты-с-галереей-глазунова' , oldSlug: 'interaktivnye-proekty-sovmestno-s-galereey-i-s-glazunova' },

  { meta: 'Образование', title: 'Киоски для Университета Синергия', slug: 'киоски-для-университета-синергия' , oldSlug: 'sensornye-kioski-dlya-uchebnykh-klassov-universiteta-sinergiya' },

  { meta: 'Культура', title: 'Совместный проект со Студией Никитина', slug: 'совместный-проект-со-студией-никитина' , oldSlug: 'sovmestnyy-proekt-s-kompaniey-studiya-nikitina' },

  { meta: 'Медицина', title: 'Киоски для обучения студентов-медиков', slug: 'киоски-для-обучения-студентов-медиков' , oldSlug: 'sensornye-kioski-dlya-obucheniya-studentov-medikov' },

  { meta: 'Банки', title: 'Киоски для АО «КБ ДельтаКредит»', slug: 'киоски-для-ао-кб-дельтакредит' , oldSlug: 'sensornye-kioski-dlya-ao-kb-deltakredit' },
